<template>
  <div>
    <div id="desctop-gallery" class="desctop-gallery gallery" itemscope itemtype="http://schema.org/ImageGallery">
      <figure
          itemprop="associatedMedia"
          itemscope
          itemtype="http://schema.org/ImageObject"
          v-for="(item, index) in desctopImages" :src="item.src"
          v-bind:key="index">
    ...
    <div id="mobile-gallery" class="mobile-gallery gallery" itemscope itemtype="http://schema.org/ImageGallery">
      <figure
          itemprop="associatedMedia"
          itemscope
          itemtype="http://schema.org/ImageObject"
          v-for="(item, index) in mobileImages" :src="item.src"
          v-bind:key="index">
        <a :href="item.src" itemprop="contentUrl" :data-size="'' + item.w + 'x' + item.h" :title="item.title">
          <img :src="item.thumbnail" :alt="item.alt" itemprop="thumbnail"/>
        </a>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      initPhotoSwipeFromDOM('.mobile-gallery');
      initPhotoSwipeFromDOM('.desctop-gallery');
